...
- Reads directly from `{OUTBOUND_DIR}/` (source of truth)
- Finds files for current day by parsing dates from filenames
- Creates daily `.tar.gz` archives in `{BACKUP_DIR}/`
...
Format:
```
2025-04-08 23:50:00 - Added {OUTBOUND_DIR}/cdr/Company1/file.csv as Company1_file.csv
2025-04-08 23:50:01 - ARCHIVED cdr 2026-04-06 -> {BACKUP_DIR}/cdr/2026-04-06.tar.gz (150 files)
