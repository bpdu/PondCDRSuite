#!/usr/bin/env python3
"""
Telna LU sync chain - pull, organize, publish
Run via cron: 30 * * * *
"""
...
LOG_FILE = "/home/cdr_admin/PondCDRSuite/logs/telna_lu_chain.log"
...
logger = logging.getLogger('telna_lu_chain')
...
def main():
    ...
    logger.info(f"========== Telna LU Chain Started at {start_time} ==========")

    base_dir = "/home/cdr_admin/PondCDRSuite"

    commands = [
        ("LU Sync", f"{base_dir}/cdr_sync/cdr_sync.sh pull configs/telna_lu.env"),
        ("LU Transform", f"python3 {base_dir}/cdr_transform/cdr_transform.py lu"),
        ("LU Load", f"python3 {base_dir}/cdr_load/cdr_load.py --mode all"),
    ]
