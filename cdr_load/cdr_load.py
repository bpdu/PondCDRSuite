#!/usr/bin/env python3
"""
cdr_load - Load CDR/LU files for HTTP access

Reads from /home/cdr_admin/outbound/
Creates three structures in /srv/cdr_load/:
  - raw: All files mixed
...
try:
    ...
    TARGET_BASE = "/srv/cdr_load"

# Setup logging
SCRIPT_DIR = os.path.dirname(os.path.abspath(__file__))
LOG_DIR = os.path.join(SCRIPT_DIR, "logs")
LOG_FILE = os.path.join(LOG_DIR, "cdr_load.log")
...
def setup_logger():
    ...
    logger = logging.getLogger('cdr_load')
...
def main():
    parser = argparse.ArgumentParser(description='Load CDR/LU files for HTTP access')
